...
const NavBar = () => {
  ...
  return (
    <div className="  px-4 sm:px-6 bg-base-100/95 backdrop-blur-md sticky top-0 z-50 shadow-lg border-b border-gray-200 dark:border-gray-800">
      {/* Logo */}
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center  py-2">
        ...
        <div className=" hidden lg:flex">
          <ul className="menu menu-horizontal gap-8 text-base font-medium">
            {navLinks}
          </ul>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <label className="swap swap-rotate">
            ...
            <svg
              className="swap-off fill-current w-7 h-7 text-blue-600"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
          ...
          <div className="hidden md:flex items-center gap-3">
            {currentUser ? (
                  ...
                  <ul className="menu dropdown-content mt-3 p-3 shadow-2xl bg-base-100 rounded-xl w-56 border">
                    ...
                    <li>
                      <button
                        ...
                        className="-600 font-medium bg-red-600 btn-sm text-white mt-2"
                      >
                        Logout
                      </button>
                    </li>
              ...
              <div className="flex gap-3">
                ...
                <NavLink
                  to="/register"
                  className="btn btn-sm bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white"
                >
                  Register
                </NavLink>
              </div>
