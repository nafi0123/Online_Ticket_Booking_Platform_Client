    ...
    <footer className="relative overflow-hidden bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="space-y-5">
            ...
            <p className="text-gray-200 text-base leading-relaxed max-w-xs">
              Book bus, train, launch & flight tickets easily. Fast, secure & reliable booking platform for Bangladesh.
            </p>
            <div className="flex gap-4 mt-6">
              {/* Social icons */}
              <a href="#" className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/30 transition-all hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><NavLink to="/tickets" className="hover:text-[#a78bfa] transition">All Tickets</NavLink></li>
              <li><NavLink to="/about" className="hover:text-[#a78bfa] transition">About Us</NavLink></li>
              <li><NavLink to="/contact" className="hover:text-[#a78bfa] transition">Contact Us</NavLink></li>
              <li><NavLink to="/privacy" className="hover:text-[#a78bfa] transition">Privacy Policy</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-xl font-bold mb-6 text-white">Payment Methods</h4>
            <div className="grid grid-cols-2 gap-4">
              {[
                { name: "bKash", url: "https://i.ibb.co/xt2JfgKk/bkash-logo.png" },
                { name: "Nagad", url: "https://i.ibb.co/PsCb0c0V/Nagad-Logo.png" },
                { name: "Rocket", url: "https://i.ibb.co/PsCb0c0V/Nagad-Logo.png" },
                { name: "Card", url: "https://i.ibb.co/NgxT6HTJ/strip-removebg-preview.png" },
              ].map((method, index) => (
                <div key={index} className="bg-white rounded-lg p-4 flex items-center justify-center hover:scale-105 transition-transform">
                  <img src={method.url} alt={method.name} className="h-10" />
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="bg-black/50 backdrop-blur-sm border-t border-white/10">
        <div className="container mx-auto px-6 py-5 text-center text-gray-300 text-sm md:text-base">
          © 2025 <span className="font-bold text-white">TicketBari</span>. All rights reserved. Made with <span className="text-red-500">♥</span> in Bangladesh
        </div>
      </div>
    </footer>
  );
