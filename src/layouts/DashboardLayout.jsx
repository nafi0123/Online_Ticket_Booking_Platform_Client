  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col">
        ...
        {/* Page Content Outlet */}
        <div className="flex-1 bg-gray-50 dark:bg-gray-900 p-6 md:p-10 min-h-screen">
          <Outlet />
        </div>
      </div>
      ...
      <div className="drawer-side">
        ...
        <aside className="w-72 min-h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col shadow-2xl">
          {/* Sidebar Header */}
          ...
          {/* Menu */}
          <ul className="menu p-4 space-y-3 flex-1 text-base">
            <li>
              <NavLink
                to="/dashboard"
                end
                className={({ isActive }) =>
                  isActive
                    ...
                    : "btn btn-ghost btn-sm w-full justify-start text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
                }
              >
                <svg
                  className="w-5 h-5"
